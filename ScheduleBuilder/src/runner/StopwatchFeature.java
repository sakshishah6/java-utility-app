...
public class StopwatchFeature {
	...
	/**Takes hours, minutes and seconds from an array and converts it to a string format for label
	 * 
	 * @param int array
	 * @return String formatted time
	 */
	 ...
	 */
	public void runStopwatch(JLabel stopwatchLabel, JButton stopwatchStartBtn, JButton stopwatchStopBtn,
			JButton stopwatchResetBtn) {
